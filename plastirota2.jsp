...
let month = months[dateObj.getMonth()];
					...
					<div class="row justify-content-between">
						<div class="col-lg-5">
							<div class="intro-excerpt">
								<h1>Plastirota</h1>
								<p class="mb-4">Plastirota Wiper Return</p>
 ...
 <%  
  ...
  <BR>
              ...
              <form  name="myform"  action="obodo2.jsp"  class="row g-3" method="POST"  onsubmit="return validateform()">
                <div class="row">
                  <div class="col-6">
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      <label class="text-black" for="lname">Machine Number</label>
                     <select name="machine_number"    class="form-control"> 
		    
			<option value="SOI1">SOI 1</option> 
		    <option value="SOI2">SOI 2</option>
		    <option value="SOI3">SOI 3</option>
		    
		    </select>
		      
		       
                      <label class="text-black" for="lname">Time and Date Fitted</label>
					  <div class="input-group">
								     
						
						    <select name="time_hour_fitted"    class="form-control" > 
						    ...
						    <select name="time_second_fitted"    class="form-control" > 
							<option value="01">01</option> 
							<option value="02">02 </option>
							<option value="03">03</option>
							<option value="04">04</option> 
						...
						<input type="date" class="form-control"  name="device_date_fitted" id="device_date_fitted"    value=<% out.println("\""+myObj+"\"");   %>   >
						</div>
                      
                        
                      <label class="text-black" for="lname">Time and Date Removed</label>
					  <div class="input-group">
								     
						
							<select name="time_hour_removed"    class="form-control" > 
							<option value="01">01</option> 
							<option value="02">02 </option>
							<option value="03">03</option>
							<option value="04">04</option> 
							...
							<select name="time_second_removed"    class="form-control" > 
							<option value="01">01</option> 
							<option value="02">02 </option>
							<option value="03">03</option>
							<option value="04">04</option> 
						...
						<input type="date" class="form-control"  name="device_date_removed" id="device_date_removed"    value=<% out.println("\""+myObj+"\"");   %>   >
						</div>
                      
                       <label class="text-black" for="lname">Output in Reams</label>
		...
		<p id="demo"></p>
                ...
                <div class="form-group mb-5">
                  <label class="text-black" for="message">Reason for Removal</label>
                  <textarea name="reason_for_removal" class="form-control" id="message" cols="30" rows="5"></textarea>
                </div>
